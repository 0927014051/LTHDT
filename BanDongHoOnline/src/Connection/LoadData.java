...
public class LoadData {
    ...
    public static void loadTablePhieuDat() {
     ...
     public static void loadTableCT_PhieuBaoHanh() {
        ...
        try {
            while (rs.next()) {
                CT_PhieuBaoHanh pbh = new CT_PhieuBaoHanh(
                        rs.getString(1).trim(),
                        rs.getString(2).trim(),
                        rs.getString(3).trim());
      ...
      public static void loadTablePhieuBaoHanh() {
        ...
        try {
            while (rs.next()) {
                PhieuBaoHanh ctpbh = new PhieuBaoHanh(
                        rs.getString(1).trim(),
                        rs.getString(2).trim(),
                        rs.getDate(3),
                        rs.getDate(4));
    ...
    public LoadData() {
        ...
        Controller.controller.arrayListKhuyenMai.removeAll(Controller.controller.arrayListCT_KhuyenMai);
